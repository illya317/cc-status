...
2. Add `"statusLine": { "type": "command", "command": "node ~/.claude/plugins/marketplaces/cc-status/dist/index.js", "padding": 0 }` to the JSON object. Do not modify any other keys.
